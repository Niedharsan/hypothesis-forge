...
Use the Supervisor guidance as the source of truth for the research objective, success criteria, novelty definition, cutoff rules, and any domain-specific constraints. Do not introduce your own hidden definitions of novelty, relevance, targetability, or success.
...
4. Identify which evidence from the synthesis or paper memory supports the logic. Use evidence IDs or stable paper IDs when available.
...
{
  "reflection_mode": "supervisor_guided_batch",
  "reflection_reviews": [
    {
      "hypothesis_id": "...",
